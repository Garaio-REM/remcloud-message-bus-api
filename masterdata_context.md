...
A user might update the listing information of a house in GARAIO REM. This message reflects such an update.
...
&nbsp;&nbsp;distancePublicTransit | integer | distance of public transit from the house
&nbsp;&nbsp;distanceShopping | integer | distance of shopping from the house
&nbsp;&nbsp;distanceKindergarden | integer | distance of kindergarden from the house
&nbsp;&nbsp;distancePrimarySchool | integer | distance of primary school from the house
&nbsp;&nbsp;distanceHighSchool | integer | distance of high school from the house
&nbsp;&nbsp;distanceHighway | integer | distance of highway from the house
&nbsp;&nbsp;hasGarage | boolean   | boolean value if the house has garage or not
&nbsp;&nbsp;hasParkingSpace | boolean | boolean value if the house has parking space or not
...
```json
{
  ...
  "data":{
    "reference":"1234.01",
    "distancePublicTransit":"100",
    "distanceShopping":"100",
    "distanceKindergarden":"100",
    "distancePrimarySchool":"100",
    "distanceHighSchool":"100",
    "distanceHighway":"100",
    "hasGarage":true,
