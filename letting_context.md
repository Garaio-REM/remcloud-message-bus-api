...
| [Letting.TenancyAgreement.DraftActivated](#lettingtenancytenancyagreementdraftactivated)            | :white_check_mark: | :x:                | The tenancy agreement has become activated.                                    |
...
The tenancy agreement has become validated. 
...
| &nbsp;&nbsp;startDate | `string` | The starting date of the tenancy agreement.                                                                 |
...
include a new key `newStartDate` in the message body and send the old starting date in the `startDate` key. 
...
| data                     | `hash`   |                                                                                                                                       |
| &nbsp;&nbsp;reference    | `string` | unique tenancy agreement identifier, eg '1234.01.0001.01'                                                                             |
| &nbsp;&nbsp;startDate    | `string` | The starting date of the tenancy agreement. If starting date of tenancy agreement changes, then here we expose the old starting date. |
| &nbsp;&nbsp;newStartDate | `string` | The updated starting date of the tenancy agreement. We expose this only when starting date of tenancy changes                         |
| &nbsp;&nbsp;state        | `string` | The current state of the tenancy agreement. It can be in validated, activated, deactivated, cancelled state                           |
...
```json
{
  ...
  "data": {
    "reference":"1234.01.0001.01",
    "startDate":"2025-08-03",
    "newStartDate":"2025-09-03",
    "state":"validated"
  }
}
```

### Letting.TenancyAgreement.DraftActivated

The state of a validated tenancy agreement has changed to activated.

| Field                    | Type     | Content / Remarks                                                                                                                     |
|--------------------------| -------- |---------------------------------------------------------------------------------------------------------------------------------------|
| eventType                | `string` | Letting.TenancyAgreement.DraftActivated                                                                                                 |
| data                     | `hash`   |                                                                                                                                       |
| &nbsp;&nbsp;reference    | `string` | unique tenancy agreement identifier, eg '1234.01.0001.01'                                                                             |
| &nbsp;&nbsp;startDate    | `string` | The starting date of the tenancy agreement. |
| &nbsp;&nbsp;state        | `string` | The current state of the tenancy agreement. It can be in validated, activated, deactivated, cancelled state                           |
...
```json
{
  "eventType":"Letting.TenancyAgreement.DraftActivated",
  "data": {
    "reference":"1234.01.0001.01",
    "startDate":"2025-08-03",
    "state":"activated"
...
The activated tenancy agreement has some new updates. 
...
| &nbsp;&nbsp;`tenancyAgreementTemplateReference`                   | `string`  | a valid tenancy agreement template reference. Only required if multiple tenancy agreement templates are configured (and matching) for the selected tenancyAgreementTypeCode                    |
