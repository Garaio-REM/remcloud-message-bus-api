...
Field | Type | Content / Remarks
---|---|---
`tenancyAgreementReference` | `longint` | unique unit identifier, eg '234.01.0001'
...
Field | Type | Content / Remarks
---|---|---
`reference` | `longint` | unique identifier for the tenancyAgreement, generated by GARAIO REM;
...
Field | Type | Content / Remarks
---|---|---
`unitReference` | `longint` | unique unit identifier, eg '234.01.0001'
