...
| &nbsp;&nbsp;`customAttributes`                        | `Hash`                  | Custom Attributes hash                                                                                                                                                                                                  |
| &nbsp;&nbsp;&nbsp;&nbsp;`existingCustomAttributeKey`  | `string/boolean/date`   | Custom Attributes key which is already defined. Any wrong data type or unknown key will be rejected (the whole request). [see example]                                                                                  |
Notes
...
#### Minimal example with custom attributes
In this example, the customAttributes key `address` must be already defined in the Core, otherwise it will be rejected.
